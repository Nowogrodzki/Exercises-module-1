...
const triangle = (a,b,c) => {
    ...
    return Math.pow(a,2) + Math.pow(b,2) === Math.pow(c, 2) ? `Kwadrat najdłuższego boku jest równy sumie dwóch pozostałych boków co oznacza, że trójkąt jest prostokątny` : `to nie jest trójkąt prostokątny`;
}
